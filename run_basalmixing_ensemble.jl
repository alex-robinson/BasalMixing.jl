...
@model function basal_mixing(age_obs, depth, dt)
    ...
    L_ref       = 1.0
    depth_scale ~ Uniform(0.8, 2.0)     # 1 m
    #depth_scale = 1.0
    m_clean     ~ Normal(0.03, 0.02)    # 0.03 m/kyr
    m_dirty     ~ Normal(0.18, 0.10)    # 0.18 m/kyr
    σ ~ Exponential(30.0)
    #σ = 30.0
